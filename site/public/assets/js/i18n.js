...
(function () {
  ...
  var ESB_I18N = window.ESB_I18N = {
    fr: {
      ...
      "ends 30 Sep": "jusqu’au 30 septembre",
      "Copied": "Copié",
      ...
      "On offer": "En promo",
      "Password changeable": "Mot de passe modifiable",
      ...
      "Covered for a year.": "Couvert pendant un an.",
      "Three things decide whether a bought account is worth having: what state it arrives in, whether you can lock it to yourself, and what happens if it goes wrong.": "Trois choses décident si un compte acheté vaut quelque chose : l’état dans lequel il arrive, si tu peux le verrouiller à ton nom, et ce qui se passe quand ça tourne mal.",
      "Condition": "État",
      "Checked before it ships": "Vérifié avant l’envoi",
      "Every login is opened and checked before it goes on the shelf: no active ban or restriction, ranked unlocked, the inbox tested, and the rank on the card is the rank on the account.": "Chaque compte est ouvert et vérifié avant d’être mis en vente : aucun ban ni restriction en cours, le classé débloqué, la boîte mail testée, et le rang affiché sur la carte est bien celui du compte.",
      "It passes or it does not ship": "Il passe le contrôle ou il ne part pas",
      "Ownership": "Propriété",
      ...
      "Email came with it, changed both in about five minutes with the guide. Logged straight into ranked with nothing flagged on it, which is the bit I was worried about.": "L’e-mail était bien fourni, j’ai changé les deux en cinq minutes avec le guide. Direct en classé, rien de signalé sur le compte, et c’était ça qui m’inquiétait.",
      ...
      "Buying an account is against Riot's terms of service, so the honest answer is that the risk is not zero. What reduces it is hygiene and the state it arrives in: every login is checked for an active ban or restriction before it goes on the shelf, and changing the email and password in the first ten minutes removes the only trail back to the sale. Anything actioned within {} months is replaced free.": "Acheter un compte est contraire aux conditions d’utilisation de Riot : la réponse honnête est que le risque n’est pas nul. Ce qui le réduit, c’est l’hygiène et l’état dans lequel il arrive — chaque compte est vérifié (aucun ban ni restriction en cours) avant d’être mis en vente, et changer l’e-mail et le mot de passe dans les dix premières minutes efface la seule trace qui remonte à la vente. Tout compte sanctionné dans les {} mois est remplacé gratuitement.",
      ...
      "A level 30 unranked is a couple of days of games. A Diamond account is weeks of ranked games at a rank where losses are expensive, plus the skins and rewards that accumulate on the way. The price tracks the hours behind the account, not the label on it.": "Un niveau 30 non classé, c’est deux jours de parties. Un compte Diamond, ce sont des semaines de parties classées à un rang où les défaites coûtent cher, plus les skins et les récompenses accumulés en chemin. Le prix suit les heures derrière le compte, pas l’étiquette dessus.",
    ...
    de: {
      ...
      "On offer": "Im Angebot",
      "Password changeable": "Passwort änderbar",
      ...
      "Covered for a year.": "Ein Jahr abgesichert.",
      "Three things decide whether a bought account is worth having: what state it arrives in, whether you can lock it to yourself, and what happens if it goes wrong.": "Drei Dinge entscheiden, ob ein gekaufter Account etwas taugt: in welchem Zustand er ankommt, ob du ihn auf dich festlegen kannst, und was passiert, wenn es schiefgeht.",
      "Condition": "Zustand",
      "Checked before it ships": "Vor dem Versand geprüft",
      "Every login is opened and checked before it goes on the shelf: no active ban or restriction, ranked unlocked, the inbox tested, and the rank on the card is the rank on the account.": "Jeder Login wird geöffnet und geprüft, bevor er ins Regal kommt: kein aktiver Bann, keine Sperre, Ranked freigeschaltet, das Postfach getestet — und der Rang auf der Karte ist der Rang auf dem Account.",
      "It passes or it does not ship": "Besteht die Prüfung oder wird nicht verkauft",
      "Ownership": "Eigentum",
      ...
      "Email came with it, changed both in about five minutes with the guide. Logged straight into ranked with nothing flagged on it, which is the bit I was worried about.": "Die E-Mail war dabei, beides in etwa fünf Minuten mit der Anleitung geändert. Direkt in Ranked rein, nichts auf dem Account markiert, und genau davor hatte ich Bammel.",
